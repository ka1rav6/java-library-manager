...
public class Start{
    ...
    public static BaseUser createAccount(Scanner in, Console console){
        ...
        while (true){
            ...
            switch (choice){
                case "1":
                    ...
                    int index = Book.partOfLibrary(bName, bAuthor);
                    if (index == -1){
                        System.out.println("Book not found in library.");
                    } else {
                        Book[] books = Library.parseLibrary();
                        user.issueBook(books[index]);
                ...
                case "2":
                    ...
                    int rindex = Book.partOfLibrary(rName, rAuthor);
                    if (rindex == -1){
                        System.out.println("Book not found in library.");
                    } else {
                        Book[] books2 = Library.parseLibrary();
                        user.returnBook(books2[rindex]);
