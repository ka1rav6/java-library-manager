...
public class BaseUser{
    ...
    // --- Serialization ---
    // Format per line in users.txt:
    // username: password,phoneNumber,email,deposit,type
    ...
    public static BaseUser deserialize(String line){
        // line format -> username: password,phoneNumber,email,deposit,type
    ...
    public static void saveAllUsers(){
        // convenience: reload, already saved via saveUsers
    }
